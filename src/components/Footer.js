...
const Footer = () => {
  ...
  <li><Link to="/projects" className="hover:text-amber-400 transition">Projects</Link></li>
  <li><Link to="/events" className="hover:text-amber-400 transition">Events</Link></li> {/* 👈 Added */}
